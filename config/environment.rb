...
Rails::Initializer.run do |config|
  ...
  #config.gem "scoped_search",               :lib => "scoped_search", :source => "http://gemcutter.org/"
  #config.gem "JasonKing-inline_attachment", :lib => "inline_attachment", :source => "http://gems.github.com/"
